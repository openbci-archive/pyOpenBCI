...
setup(
  ...
  url = 'https://github.com/OpenBCI/OpenBCI_Python/blob/Andrea/setup.py',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/andreaortuno/pyOpenBCI/archive/0.1.tar.gz',    # I explain this later on
